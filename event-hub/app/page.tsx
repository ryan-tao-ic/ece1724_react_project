        ...
        <Container>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <h3 className="text-xl font-bold">{t('home.features.eventManagement.title')}</h3>
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <h3 className="text-xl font-bold">{t('home.features.qrCode.title')}</h3>
              <p className="text-muted-foreground">
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <h3 className="text-xl font-bold">{t('home.features.realTime.title')}</h3>
              <p className="text-muted-foreground">
